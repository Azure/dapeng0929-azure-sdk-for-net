...
namespace Azure.Search.Documents.Models
{
    ...
    internal partial class UnknownVectorSearchCompression : VectorSearchCompression
    {
        ...
        internal UnknownVectorSearchCompression(string compressionName, VectorSearchCompressionKind kind, RescoringOptions rescoringOptions, int? truncationDimension) : base(compressionName, kind, rescoringOptions, truncationDimension)
        {
            Kind = kind;
        }
    }
