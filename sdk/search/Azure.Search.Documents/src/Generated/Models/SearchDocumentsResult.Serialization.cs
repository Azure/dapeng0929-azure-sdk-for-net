...
namespace Azure.Search.Documents.Models
{
    internal partial class SearchDocumentsResult
    {
        internal static SearchDocumentsResult DeserializeSearchDocumentsResult(JsonElement element)
        {
            ...
            DebugInfo searchDebugInfo = default;
            ...
            SemanticQueryRewriteResultType? searchSemanticQueryRewriteResultType = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("@search.debugInfo"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                    ...
                    searchDebugInfo = DebugInfo.DeserializeDebugInfo(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("@search.semanticQueryRewriteResultType"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    searchSemanticQueryRewriteResultType = new SemanticQueryRewriteResultType(property.Value.GetString());
                    continue;
                }
            }
            return new SearchDocumentsResult(
                ...
                searchSemanticQueryRewriteResultType);
        }
