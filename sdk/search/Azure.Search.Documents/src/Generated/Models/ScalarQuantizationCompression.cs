...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class ScalarQuantizationCompression : VectorSearchCompression
    {
        ...
        internal ScalarQuantizationCompression(string compressionName, VectorSearchCompressionKind kind, RescoringOptions rescoringOptions, int? truncationDimension, ScalarQuantizationParameters parameters) : base(compressionName, kind, rescoringOptions, truncationDimension)
        {
