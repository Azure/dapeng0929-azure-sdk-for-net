...
namespace Azure.Search.Documents.Indexes.Models
{
    ...
    public partial class IndexingParametersConfiguration
    {
        ...
        /// <param name="markdownParsingSubmode"> Specifies the submode that will determine whether a markdown file will be parsed into exactly one search document or multiple search documents. </param>
        /// <param name="markdownHeaderDepth"> Specifies the max header depth that will be considered while grouping markdown content. </param>
        ...
        /// <summary> Specifies the submode that will determine whether a markdown file will be parsed into exactly one search document or multiple search documents. </summary>
        public MarkdownParsingSubmode? MarkdownParsingSubmode { get; set; }
        /// <summary> Specifies the max header depth that will be considered while grouping markdown content. </summary>
