...
namespace Azure.Search.Documents.Models
{
    ...
    public static partial class SearchModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Indexes.Models.IndexerCurrentState"/>. </summary>
        ...
        public static QueryRewritesDebugInfo QueryRewritesDebugInfo(IEnumerable<string> text = null, IEnumerable<IList<string>> vectors = null)
        {
            text ??= new List<string>();
            vectors ??= new List<IList<string>>();

            return new QueryRewritesDebugInfo(text?.ToList(), vectors?.ToList());
        }
