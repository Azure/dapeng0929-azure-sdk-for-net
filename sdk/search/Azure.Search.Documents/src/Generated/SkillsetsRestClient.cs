...
namespace Azure.Search.Documents
{
    internal partial class SkillsetsRestClient
    {
        ...
        internal HttpMessage CreateResetSkillsRequest(string skillsetName, SkillNames skillNames)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response> ResetSkillsAsync(string skillsetName, SkillNames skillNames, CancellationToken cancellationToken = default)
        {
            if (skillsetName == null)
            {
                throw new ArgumentNullException(nameof(skillsetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="skillsetName"/> or <paramref name="skillNames"/> is null. </exception>
        public Response ResetSkills(string skillsetName, SkillNames skillNames, CancellationToken cancellationToken = default)
        {
            if (skillsetName == null)
            {
                throw new ArgumentNullException(nameof(skillsetName));
