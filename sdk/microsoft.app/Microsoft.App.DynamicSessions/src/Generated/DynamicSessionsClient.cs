...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class DynamicSessionsClient
    {
        ...
        public virtual CodeExecution GetCodeExecutionClient(string apiVersion = "2024-09-01")
        {
        ...
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual SessionResourceFiles GetSessionResourceFilesClient(string apiVersion = "2024-09-01")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));
