...
namespace Microsoft.App.DynamicSessions
{
    ...
    public partial class SessionCodeExecutionResponse
    {
        ...
        internal SessionCodeExecutionResponse(CodeExecutionStatus status, string stdout, string stderr, BinaryData result, long executionTimeInMilliseconds)
        {
        ...
        internal SessionCodeExecutionResponse(string id, CodeExecutionStatus status, string stdout, string stderr, BinaryData result, long executionTimeInMilliseconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Status = status;
            Stdout = stdout;
