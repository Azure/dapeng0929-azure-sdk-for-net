...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AIOpenAIModelFactory
    {
        ...
        public static AzureSearchChatExtensionParameters AzureSearchChatExtensionParameters(OnYourDataAuthenticationOptions authentication = null, int? documentCount = null, bool? shouldRestrictResultScope = null, int? strictness = null, int? maxSearchQueries = null, bool? allowPartialResult = null, IEnumerable<OnYourDataContextProperty> includeContexts = null, Uri searchEndpoint = null, string indexName = null, AzureSearchIndexFieldMappingOptions fieldMappingOptions = null, AzureSearchQueryType? queryType = null, string semanticConfiguration = null, string filter = null, OnYourDataVectorizationSource embeddingDependency = null)
        {
        ...
        public static AzureCosmosDBChatExtensionParameters AzureCosmosDBChatExtensionParameters(OnYourDataAuthenticationOptions authentication = null, int? documentCount = null, bool? shouldRestrictResultScope = null, int? strictness = null, int? maxSearchQueries = null, bool? allowPartialResult = null, IEnumerable<OnYourDataContextProperty> includeContexts = null, string databaseName = null, string containerName = null, string indexName = null, AzureCosmosDBFieldMappingOptions fieldMappingOptions = null, OnYourDataVectorizationSource embeddingDependency = null)
        {
            includeContexts ??= new List<OnYourDataContextProperty>();
        ...
        public static ElasticsearchChatExtensionParameters ElasticsearchChatExtensionParameters(OnYourDataAuthenticationOptions authentication = null, int? documentCount = null, bool? shouldRestrictResultScope = null, int? strictness = null, int? maxSearchQueries = null, bool? allowPartialResult = null, IEnumerable<OnYourDataContextProperty> includeContexts = null, Uri endpoint = null, string indexName = null, ElasticsearchIndexFieldMappingOptions fieldMappingOptions = null, ElasticsearchQueryType? queryType = null, OnYourDataVectorizationSource embeddingDependency = null)
        {
            includeContexts ??= new List<OnYourDataContextProperty>();
        ...
        public static MongoDBChatExtensionParameters MongoDBChatExtensionParameters(OnYourDataAuthenticationOptions authentication = null, int? documentCount = null, bool? shouldRestrictResultScope = null, int? strictness = null, int? maxSearchQueries = null, bool? allowPartialResult = null, IEnumerable<OnYourDataContextProperty> includeContexts = null, string endpoint = null, string collectionName = null, string databaseName = null, string appName = null, string indexName = null, MongoDBChatExtensionParametersFieldsMapping fieldsMapping = null, BinaryData embeddingDependency = null)
        {
            includeContexts ??= new List<OnYourDataContextProperty>();
        ...
        public static PineconeChatExtensionParameters PineconeChatExtensionParameters(OnYourDataAuthenticationOptions authentication = null, int? documentCount = null, bool? shouldRestrictResultScope = null, int? strictness = null, int? maxSearchQueries = null, bool? allowPartialResult = null, IEnumerable<OnYourDataContextProperty> includeContexts = null, string environmentName = null, string indexName = null, PineconeFieldMappingOptions fieldMappingOptions = null, OnYourDataVectorizationSource embeddingDependency = null)
        {
            includeContexts ??= new List<OnYourDataContextProperty>();
        ...
        public static ChatResponseMessage ChatResponseMessage(ChatRole role = default, string refusal = null, string content = null, IEnumerable<ChatCompletionsToolCall> toolCalls = null, FunctionCall functionCall = null, AzureChatExtensionsMessageContext azureExtensionsContext = null)
        {
            toolCalls ??= new List<ChatCompletionsToolCall>();
        ...
        public static Upload Upload(string id = null, DateTimeOffset createdAt = default, string filename = null, long bytes = default, string purpose = null, UploadStatus status = default, DateTimeOffset expiresAt = default, UploadObject? @object = null, OpenAIFile file = null)
        {
            return new Upload(
                id,
                createdAt,
