...
namespace Azure.ResourceManager.Compute.Models
{
    ...
    public partial class ExecutedValidation
    {
        ...
        internal ExecutedValidation(string executedValidationType, string status, string version, DateTimeOffset? executionOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
